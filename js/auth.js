...
function displayAccountData(data) {
    ...
    if (memberSinceEl && data.createdAt && data.createdAt.toDate) {
        try {
            memberSinceEl.textContent = data.createdAt.toDate().toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' });
        } catch(e) {
